...
--seg_path=${experiments_path}/first_stage/${model}/main_train_infer \
...
--save_path=${experiments_path}/second_stage/${second_stage_dir}/main_train_infer_detection_1 \
--save_postfix="_GT" \
--separate_folder || { echo 'Error during moving file.'; exit 1; }

python3 post_processing/move_file.py \
--data_path=${data_path}/test/main/label_crop_clip \
--save_path=${experiments_path}/second_stage/${second_stage_dir}/main_train_infer_detection_2 \
--save_postfix="_GT" \
--separate_folder || { echo 'Error during moving file.'; exit 1; }
...
do
  python3 caculate_metric.py \
  --seg_path=${experiments_path}/second_stage/${second_stage_dir}/main_train_infer_detection_1 \
  --seg_find=*/*${postfix}.nii.gz \
  --label_path=${data_path}/test/main/label_crop_clip \
  --metric_result_path=${experiments_path}/second_stage/${second_stage_dir}/main_train_infer_detection_1/${postfix}_metric.xlsx \
...
do
  python3 caculate_metric.py \
  --seg_path=${experiments_path}/second_stage/${second_stage_dir}/main_train_infer_detection_2 \
  --seg_find=*/*${postfix}.nii.gz \
  --label_path=${data_path}/test/main/label_crop_clip \
  --metric_result_path=${experiments_path}/second_stage/${second_stage_dir}/main_train_infer_detection_2/${postfix}_metric.xlsx \
  --multiprocess || { echo 'Error during calculating metric.'; exit 1; }
done
...
do
  ...
  --seg=${experiments_path}/second_stage/${second_stage_dir}/main_train_infer_detection_1 \
  --seg_find=*/*${postfix}.nii.gz \
...
#do
#  python3 SparrowLink_metric.py \
#  --seg=${experiments_path}/second_stage/${second_stage_dir}/main_train_infer_detection_2 \
#  --seg_find=*/*${postfix}.nii.gz \
...
do
  ...
  --seg_path=${experiments_path}/second_stage/${second_stage_dir}/main_train_infer_detection_1 \
  --seg_find=*/*${postfix}.nii.gz \
  --label_path=${experiments_path}/second_stage/${second_stage_dir}/main_train_infer_detection_1 \
  --label_find=*/*_sphere_gt_segment.nii.gz \
  --metric_result_path=${experiments_path}/second_stage/${second_stage_dir}/main_train_infer_detection_1/${postfix}_ablation_gt_color_metric.xlsx \
  --multiprocess || { echo 'Error during calculating metric.'; exit 1; }
done
