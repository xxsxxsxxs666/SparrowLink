...
raw="/public_bme/data/v-xiongxs/nnunetv2/nnunetv2_raw"
preprocessed="/public_bme/data/v-xiongxs/nnunetv2/nnunetv2_preprocessed"
results="/public_bme/data/v-xiongxs/nnunetv2/nnunetv2_results"
export nnUNet_raw=${raw}
export nnUNet_preprocessed=${preprocessed}
export nnUNet_results=${results}

experiments_path="/public/home/v-xiongxx/Graduate_project/Cardio_vessel_segmentaion_based_on_monai/experiments/Graduate_project/CAS1000_two_stage"
data_path="/public_bme/data/v-xiongxs/CAS1000_split/"
configs_path="/public/home/v-xiongxx/Graduate_project/Cardio_vessel_segmentaion_based_on_monai/configs/CAS1000_two_stage"
# /public/home/v-xiongxx/Graduate_project/Cardio_vessel_segmentaion_based_on_monai/experiments/Graduate_project/CAS1000_two_stage/first_stage/${model}/main_train_infer
task_id=666
task_name=Dataset666_CAS1000
### data conversion
#python3 /public/home/v-xiongxx/Graduate_project/nnUnetv2/nnUNet/nnunetv2/dataset_conversion/Dataset666_CAS1000.py \
...
do
  ...
  do
    ...
    --img_path=${data_path}/${data_fold[${mode}]} \
    --output_path=${experiments_path}/first_stage/${model}/main_${mode}_infer_SAL \
    --workers=8 || { echo 'Error during inference.'; exit 1; }
  done
done

python3 caculate_metric.py \
--seg_path=${experiments_path}/first_stage/${model}/main_test_infer_SAL \
...
--persist_path=${data_path}/second_stage/${second_stage_dir}/persist_cache_CAS1000 \
...
for postfix in "CS_M" "_RCS" "_RCS_TWO" "_CS_M_TWO" "_RCS_SELECTED" "_RCS_SELECTED_TWO" "_RCS_NEW" "_RCS_NEW_TWO" "_RS" "RS_TWO";
do
  python3 caculate_metric.py \
