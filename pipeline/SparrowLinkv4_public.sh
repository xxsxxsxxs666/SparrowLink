...
# experiments_path="/public_bme/data/v-xiongxs/SparrowLink/experiments/UII"
...
--workers=8 || { echo 'Error during training.'; exit 1; }
fi
#### 2. inference
...
do
  ...
  do
    ...
    --pretrain_weight_path=${experiments_path}/first_stage/${model}/checkpoint/best_metric_model.pth \
...
--CS_W=${experiments_path}/first_stage/${model}/checkpoint/best_metric_model.pth \
...
for postfix in "CS_M" "_RCS" "_ARCS" "_ARCS_TWO" "_CS_M_TWO" "_RCS_SELECTED" "_RCS_SELECTED_TWO" "_ARCS_SELECTED" "_ARCS_SELECTED_TWO" "_RCS_NEW" "_RCS_NEW_TWO" "_ARCS_NEW" "_ARCS_NEW_TWO" "_csaDM_TWO";
do
  python3 caculate_metric.py \
...
for postfix in "CS_M" "_RCS" "_ARCS" "_RCS_SELECTED" "_ARCS_SELECTED" "_RCS_NEW" "_ARCS_NEW" "_csaDM_TWO";
do
  python3 SparrowLink_metric.py \
  --seg=${experiments_path}/second_stage/${second_stage_dir}/main_test_infer_detection_1 \
  --seg_find=*/*${postfix}.nii.gz \
